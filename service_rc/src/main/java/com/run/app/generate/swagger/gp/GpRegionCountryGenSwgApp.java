...
import com.run.bll.extend.split.gp.GpRegionCountrySplBll;
import com.run.bll.extend.unity.gp.GpRegionCountryUntBll;
...
@Api(value = "GpRegionCountry",tags="地区信息。")
...
public class GpRegionCountryGenSwgApp extends BaseSwgApp {
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串", required = true, dataType = "GpRegionCountry") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpRegionCountryAddList") })
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpRegionCountryDeleteByIdList")
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，实体属性", required = true, dataType = "GpRegionCountry") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpRegionCountryGetList") })
	...
	public ResultModel getListByJsonData() {
		...
		selectBuffer.append("select A.id id,A.iso_code isoCode,A.chinese_name chineseName,A.english_name englishName,A.is_display_code isDisplayCode,A.longitude longitude,A.latitude latitude,A.area area,A.remark remark  from gp_region_country A inner join gp_region_country B on A.id=B.id where 1=1 ");
