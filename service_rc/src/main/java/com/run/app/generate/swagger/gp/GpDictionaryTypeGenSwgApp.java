...
import com.run.bll.extend.split.gp.GpDictionaryTypeSplBll;
import com.run.bll.extend.unity.gp.GpDictionaryTypeUntBll;
...
@Api(value = "GpDictionaryType",tags="字典类型。")
@RequestMapping(value = "/generate/swagger/gp/gpDictionaryType")
public class GpDictionaryTypeGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpDictionaryTypeSplBll")
	protected GpDictionaryTypeSplBll gpDictionaryTypeSplBll;
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpDictionaryTypeAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpDictionaryTypeParameter.AddList jsonData) {
		ResultModel result = gpDictionaryTypeUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpDictionaryTypeUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpDictionaryTypeDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpDictionaryTypeParameter.DeleteByIdList jsonData) {
		ResultModel result = gpDictionaryTypeUntBll.deleteByIdList(jsonData.getIdList());
	...
	public ResultModel updateList(@RequestBody GpDictionaryTypeParameter.UpdateList jsonData) {
		ResultModel result = gpDictionaryTypeUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody GpDictionaryTypeParameter.AddList jsonData) {
		ResultModel result = gpDictionaryTypeUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpDictionaryTypeParameter.AddList jsonData) {
		ResultModel result = gpDictionaryTypeUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	public ResultModel getModel(@RequestParam String id) {
		ResultModel result = gpDictionaryTypeUntBll.getModel(id);
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpDictionaryTypeGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpDictionaryTypeParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpDictionaryTypeUntBll.getList(jsonData);
	...
	public void exportExcel() {
		...
		String fileName = "字典类型列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
