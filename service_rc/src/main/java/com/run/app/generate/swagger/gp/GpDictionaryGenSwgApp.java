...
import com.run.bll.extend.split.gp.GpDictionarySplBll;
...
@Api(value = "GpDictionary",tags="字典信息。")
@RequestMapping(value = "/generate/swagger/gp/gpDictionary")
public class GpDictionaryGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpDictionarySplBll")
	protected GpDictionarySplBll gpDictionarySplBll;

	@ApiOperation(value = "新增记录", notes = "新增单条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串", required = true, dataType = "GpDictionary") })
	@RequestMapping(value = "/add", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel add(@RequestBody GpDictionary jsonData) {
		ResultModel result = gpDictionaryUntBll.add(jsonData);

		return result;
	}

	@ApiOperation(value = "批量新增", notes = "新增多条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpDictionaryAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpDictionaryParameter.AddList jsonData) {
		ResultModel result = gpDictionaryUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpDictionaryUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpDictionaryDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpDictionaryParameter.DeleteByIdList jsonData) {
		ResultModel result = gpDictionaryUntBll.deleteByIdList(jsonData.getIdList());

		return result;
	}

	@ApiOperation(value = "修改记录", notes = "修改指定记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，实体属性", required = true, dataType = "GpDictionary") })
	@RequestMapping(value = "/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel update(@RequestBody GpDictionary jsonData) {
		ResultModel result = gpDictionaryUntBll.update(jsonData);
	...
	public ResultModel updateList(@RequestBody GpDictionaryParameter.UpdateList jsonData) {
		ResultModel result = gpDictionaryUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody GpDictionaryParameter.AddList jsonData) {
		ResultModel result = gpDictionaryUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpDictionaryParameter.AddList jsonData) {
		ResultModel result = gpDictionaryUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	public ResultModel getModel(@RequestParam String id) {
		ResultModel result = gpDictionaryUntBll.getModel(id);
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpDictionaryGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpDictionaryParameter.GetList jsonData) {
		// 处理业务与返回数据
