...
import com.run.bll.extend.split.gp.GpMessageSplBll;
import com.run.bll.extend.unity.gp.GpMessageUntBll;
...
@Api(value = "GpMessage",tags="系统消息。")
@RequestMapping(value = "/generate/swagger/gp/gpMessage")
public class GpMessageGenSwgApp extends BaseSwgApp {

	@Autowired
	@Qualifier("gpMessageUntBll")
	protected GpMessageUntBll gpMessageUntBll;

	@Autowired
	@Qualifier("gpMessageSplBll")
	protected GpMessageSplBll gpMessageSplBll;
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpMessageAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpMessageParameter.AddList jsonData) {
		ResultModel result = gpMessageUntBll.add(jsonData.getEntityList());
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpMessageDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpMessageParameter.DeleteByIdList jsonData) {
		ResultModel result = gpMessageUntBll.deleteByIdList(jsonData.getIdList());

		return result;
	}

	@ApiOperation(value = "修改记录", notes = "修改指定记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，实体属性", required = true, dataType = "GpMessage") })
	@RequestMapping(value = "/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel update(@RequestBody GpMessage jsonData) {
		ResultModel result = gpMessageUntBll.update(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody GpMessageParameter.AddList jsonData) {
		ResultModel result = gpMessageUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpMessageParameter.AddList jsonData) {
		ResultModel result = gpMessageUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpMessageGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpMessageParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpMessageUntBll.getList(jsonData);
	...
	public void exportExcel() {
		...
		String fileName = "系统消息列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
