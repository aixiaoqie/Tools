...
import com.run.bll.extend.split.gp.GpStationSplBll;
import com.run.bll.extend.unity.gp.GpStationUntBll;
...
@Api(value = "GpStation",tags="岗位。")
@RequestMapping(value = "/generate/swagger/gp/gpStation")
public class GpStationGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpStationSplBll")
	protected GpStationSplBll gpStationSplBll;
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpStationAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpStationParameter.AddList jsonData) {
		ResultModel result = gpStationUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpStationUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpStationDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpStationParameter.DeleteByIdList jsonData) {
		ResultModel result = gpStationUntBll.deleteByIdList(jsonData.getIdList());
    ...
    public ResultModel updateListWithDff(@RequestBody GpStationParameter.AddList jsonData) {
		ResultModel result = gpStationUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpStationParameter.AddList jsonData) {
		ResultModel result = gpStationUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpStationGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpStationParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpStationUntBll.getList(jsonData);
	...
	public ResultModel getListByJsonData() {
		...
		selectBuffer.append("select A.id id,A.serial_no serialNo,A.name name,A.responsibility responsibility,A.remark remark,A.add_time addTime,A.update_time updateTime  from gp_station A inner join gp_station B on A.id=B.id where 1=1 ");
