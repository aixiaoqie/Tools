...
import com.run.bll.extend.split.gp.GpRegionSplBll;
import com.run.bll.extend.unity.gp.GpRegionUntBll;
...
@Api(value = "GpRegion",tags="地区信息。")
@RequestMapping(value = "/generate/swagger/gp/gpRegion")
public class GpRegionGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpRegionSplBll")
	protected GpRegionSplBll gpRegionSplBll;

	@ApiOperation(value = "新增记录", notes = "新增单条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串", required = true, dataType = "GpRegion") })
	@RequestMapping(value = "/add", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel add(@RequestBody GpRegion jsonData) {
		ResultModel result = gpRegionUntBll.add(jsonData);

		return result;
	}

	@ApiOperation(value = "批量新增", notes = "新增多条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpRegionAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpRegionParameter.AddList jsonData) {
		ResultModel result = gpRegionUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpRegionUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpRegionDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpRegionParameter.DeleteByIdList jsonData) {
		ResultModel result = gpRegionUntBll.deleteByIdList(jsonData.getIdList());

		return result;
	}

	@ApiOperation(value = "修改记录", notes = "修改指定记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，实体属性", required = true, dataType = "GpRegion") })
	@RequestMapping(value = "/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel update(@RequestBody GpRegion jsonData) {
		ResultModel result = gpRegionUntBll.update(jsonData);
	...
	public ResultModel updateList(@RequestBody GpRegionParameter.UpdateList jsonData) {
		ResultModel result = gpRegionUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody GpRegionParameter.AddList jsonData) {
		ResultModel result = gpRegionUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpRegionParameter.AddList jsonData) {
		ResultModel result = gpRegionUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpRegionGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpRegionParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpRegionUntBll.getList(jsonData);
